package com.javauservice.mch.restsample.controller;

import com.javauservice.mch.restsample.model.Calculation;
...
public class CalculationController {
    ...
    public Calculation sqrt(@PathVariable(value="value") String aValue) {
        ...
        if(aValue!=null&&aValue.matches(PATTERN)){
            ...
            sqrtValue="Base or/and Exponent is/are not set to numeric value.";
        }
